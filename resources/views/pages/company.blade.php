...
@section('title', 'Entreprise | '.env('APP_NAME'))
...
<div class="" id="filters">
        ...
        <div class="input-group">
            <input type="search" class="form-control rounded" placeholder="Nom de l'entreprise" aria-label="Search"
        ...
        <!-- Bouton Compétences -->
        <div class="btn-group">
            <button type="button" class="btn btn-primary">Compétences</button>
            <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown"
                aria-expanded="false">
                <span class="visually-hidden">Toggle Dropdown</span>
            </button>
        ...
        <!-- Bouton Nombre stagiaires CESI déjà acceptés -->
        <div class="btn-group">
            <button type="button" class="btn btn-primary">Nb stagiaires CESI déjà acceptés</button>
            <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown"
                aria-expanded="false">
                <span class="visually-hidden">Toggle Dropdown</span>
            </button>
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#">4 ou +</a></li>
            </ul>
        </div>
    </div>
</div>
